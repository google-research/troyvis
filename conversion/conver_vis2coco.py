...
###  for YTVIS19
anns = json.load(open('datasets/ytvis_2019/annotations/train.json','rb'))
new_images = []
new_annotations = []
vid_imgid_mapping = {}
image_id_start = 0
...
### for YTVIS21
anns = json.load(open('datasets/ytvis_2021/annotations/instances.json','rb'))
new_images = []
new_annotations = []
vid_imgid_mapping = {}
image_id_start = 0
...
with open('datasets/ytvis_2021/annotations/ytvis21_cocofmt.json', 'w') as f: 
    json.dump(new_anns, f)
