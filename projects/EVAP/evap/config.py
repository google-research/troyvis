...
"""
EVA-Perceiver config.
"""
from detectron2.config import CfgNode as CN


def add_evap_config(cfg):
    """
    Add config for EVA-Perceiver.
    """
    # newly added
    cfg.SOLVER.FREEZE_BACKBONE = False
    cfg.SOLVER.FREEZE_TEXT_ENCODER = False
    cfg.MODEL.BACKBONE_TEACHER = CN()
    cfg.MODEL.BACKBONE_TEACHER.NAME = "D2SwinTransformer"
    cfg.MODEL.DISTILL_WEIGHT = 1.0
    cfg.MODEL.EFFI_EARLY_FUSION = False # removing feature with stride=8
    cfg.MODEL.EFFI_LVL = 1 # efficient level of early fusion
    cfg.SOLVER.TRAIN_PREDICTOR = False # by default, we don't train predictor (keep it frozen)
    ...
    cfg.MODEL.EFFIVIT = CN()
    cfg.MODEL.EFFIVIT.WIDTH_LIST = [32, 64, 128, 256, 512]
    cfg.MODEL.EFFIVIT.DEPTH_LIST = [1, 2, 2, 8, 8]
    cfg.MODEL.EFFIVIT.WEIGHTS = "weights/l2-r384.pt"
    cfg.MODEL.EFFIVIT.OUT_FEATURES = ["res2", "res3", "res4", "res5"]
    cfg.MODEL.EFFIVIT.DIM = 16
    ...
    cfg.MODEL.ELAEncoder.use_encoder_idx = [3] # 64x downsampled
    ...
    cfg.MODEL.ELAEncoder.act = 'gelu'
    cfg.MODEL.ELAEncoder.eval_size = None
    cfg.MODEL.ELAEncoder.dim_feedforward=2048
    ...
    cfg.MODEL.USE_OFFLINE_CLS_EMBED = False
    ...
    cfg.MODEL.TEXT.DIR = "projects/EVAP/clip_vit_base_patch32"
