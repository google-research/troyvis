...
from .models.evap_model_dpl import EVAP_Model_DPL
...
class EVAP_DPL(nn.Module):
    """
    Implement EVAP_DPL (for deployment only)
    """
    ...
    def __init__(self, cfg):
        ...
        self.glee = EVAP_Model_DPL(cfg, self.device, self.video_info, cfg.MODEL.CONTRAS_MEAN)
    ...
    def forward(self, batched_inputs):
        ...
        if self.training:
            raise ValueError("EVAP_DPL is only used for inference rather than training")
        else:  # evaluation
