...
sys.path.insert(1, os.path.join(ROOT, "../../third_party"))
from evap import add_evap_config, build_detection_train_loader, build_detection_test_loader
from evap.backbone.eva01 import get_vit_lr_decay_rate
from evap.data import (
...
from evap.data import build_custom_train_loader, YTVISEvaluator
    ...
    def build_test_loader(cls, cfg, dataset_name):
        if  'ytvis' in dataset_name or 'ovis' in dataset_name or 'video' in dataset_name or 'rvos' in dataset_name or 'ytbvos' in dataset_name or 'lvvis' in dataset_name:
            if cfg.INPUT.DATASET_MAPPER_NAME == 'coco_instance_lsj':
                ...
                # For inference on video datasets, it uses different dataset mapper
...
def main(args):
    ...
    if args.eval_only:
        ...
        if comm.is_main_process():
            ...
            # for lv-vis
            os.system(f"cp {cfg.OUTPUT_DIR}/inference/results.json .")
        return res
